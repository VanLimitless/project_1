        ...
        <div class='form-group'>
            ...
            <div  class=' col-xs-8'>
                <input id='username' name='username' class='form-control' type="text"
                       required minlength='4' maxlength="16" pattern='^[a-zA-Z0-9]{4,16}$'
                       value
                       title='Username can only contain alphanumeric characters and must be betwen 4 and 16 characters long.'>
            </div>
        </div>
        <div class='form-group'>
            ...
            <div  class=' col-xs-8'>
                <input id='password1' name='password1' class='form-control' type="password"
                       required minlength="4" pattern=".{4,}"
